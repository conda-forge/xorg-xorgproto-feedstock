...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-xorgproto-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-xorgproto-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add xorg-xorgproto
# for installing globally
pixi global install xorg-xorgproto
```
...
It is possible to list all of the versions of `xorg-xorgproto` available on your platform:
...
```
pixi search xorg-xorgproto --channel conda-forge
```
